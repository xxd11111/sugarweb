...
(
    ...
    `script_content` varchar(255) default null comment '',
    `create_time`    datetime     default null comment '',
    `update_time`    datetime     default null comment '',
    PRIMARY KEY (`node_id`)
) engine = innodb comment = '';
...
(
    ...
    `system_msg`     text         default null comment '',
    `question`       text         default null comment '',
    `answer`         text         default null comment '',
    `message`        text         default null comment '',
    `start_time`     datetime     default null comment '',
    `end_time`       datetime     default null comment '',
    `cost_time`      bigint(11) default null comment '',
...
(
    ...
    `status`            varchar(255) default null comment '',
    `performance_id`    varchar(255) default null comment '',
    `tts_mode`          varchar(255) default null comment '',
    `live_platform`     varchar(255) default null comment '',
    `local_output_mode` varchar(255) default null comment '',
    `websocket_mode`    varchar(255) default null comment '',
    `create_time`       datetime     default null comment '',
    `update_time`       datetime     default null comment '',
