...
public class AliyunSMSClient implements SMSClient {
    ...
    public void listTemplate(int pageIndex, int pageSize) {
        ...
        for (QuerySmsTemplateListResponseBody.QuerySmsTemplateListResponseBodySmsTemplateList querySmsTemplateListResponseBodySmsTemplateList : response.getBody().getSmsTemplateList()) {
