package com.sugarweb.support.dict.auto;

import com.google.common.collect.ImmutableSet;
import com.google.common.reflect.ClassPath;
import com.sugarweb.support.dict.api.DictionaryCode;
import com.sugarweb.support.dict.api.DictionaryItem;
import com.sugarweb.support.dict.api.InnerDictionary;
...
public class DictionaryAutoRegistry extends AbstractAutoRegistry<Dictionary> {
    ...
    @Override
    protected void insert(Dictionary o) {
        dictionaryService.put(o);
    }

    @Override
    protected void merge(Dictionary db, Dictionary scan) {
        //ignore
    }

    @Override
    protected void deleteByCondition(Collection<Dictionary> scans) {
        Collection<Dictionary> all = dictionaryService.getAll();
        Collection<String> removeIds = new ArrayList<>();
        for (Dictionary db : all) {
            boolean contain = false;
            for (Dictionary scan : scans) {
    ...
    @Override
    protected Dictionary selectOne(Dictionary o) {
        return dictionaryService.get(o.getDictGroup(), o.getDictCode()).orElse(null);
    }

    @Override
    public Collection<Dictionary> scan() {
        ...
        List<Dictionary> sugarcoatDictionaries = new ArrayList<>();
