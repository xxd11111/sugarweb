package com.sugarweb.support.dict.domain;
...
public class SugarcoatDictionaryManager implements DictionaryManager<SugarcoatDictionary> {
    ...
    private final BaseDictionaryRepository dictionaryRepository;

    public SugarcoatDictionaryManager(BaseDictionaryRepository dictionaryRepository) {
