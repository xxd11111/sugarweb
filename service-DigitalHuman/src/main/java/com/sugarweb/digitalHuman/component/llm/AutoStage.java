...
import com.sugarweb.digitalHuman.component.PromptUtil;
...
import com.sugarweb.digitalHuman.component.llm.input.blbl.BlblInputComponent;
import com.sugarweb.digitalHuman.component.llm.input.websocket.PerformanceWebsocketServer;
import com.sugarweb.digitalHuman.component.llm.memory.DatasetMemoryComponent;
import com.sugarweb.digitalHuman.component.llm.memory.PerformanceMemoryComponent;
...
import com.sugarweb.digitalHuman.component.llm.output.websocket.WebsocketOutputConsumer;
import com.sugarweb.digitalHuman.component.llm.thought.*;
...
public class AutoStage {
    ...
    public AutoStage(StageContext stageContext) {
        ...
        Kb kb = stageContext.getKb();
        if (kb == null) {
            datasetMemoryComponent = null;
        } else {
            //装载记忆能力
            datasetMemoryComponent = new DatasetMemoryComponent(kb);
        }
        ...
        streamThoughtComponent = StreamThoughtComponent.builder()
                .modelId(stageContext.getAgent().getChatModelId())
    ...
    public void script(long thinkId, Script script, ScriptNode scriptNode) {
        ...
        Stage stage = stageContext.getStage();
        Agent agent = stageContext.getAgent();
        ...
        currentMsg.setChatModelId(agent.getChatModelId());
        currentMsg.setActorId(agent.getAgentId());
    ...
    public void answer(long thinkId) {
        ...
        // 系统提示语
        Agent agent = stageContext.getAgent();
        String systemPrompt = PromptUtil.getPrompt(agent.getPrompt(), thoughtRequest.getContextVariables());
        thoughtRequest.setSystemMsg(systemPrompt);
        // 准备提问消息
